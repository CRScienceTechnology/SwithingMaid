# 1 "C:\\Users\\Administrator\\AppData\\Local\\Arduino15\\RemoteSketchbook\\ArduinoCloud\\78686059\\ESP01S-SwithingMaid\\ESP01S-SwithingMaid.ino"
# 2 "C:\\Users\\Administrator\\AppData\\Local\\Arduino15\\RemoteSketchbook\\ArduinoCloud\\78686059\\ESP01S-SwithingMaid\\ESP01S-SwithingMaid.ino" 2
# 3 "C:\\Users\\Administrator\\AppData\\Local\\Arduino15\\RemoteSketchbook\\ArduinoCloud\\78686059\\ESP01S-SwithingMaid\\ESP01S-SwithingMaid.ino" 2
# 4 "C:\\Users\\Administrator\\AppData\\Local\\Arduino15\\RemoteSketchbook\\ArduinoCloud\\78686059\\ESP01S-SwithingMaid\\ESP01S-SwithingMaid.ino" 2
...
void callback(char *topic, byte *payload, unsigned int length)
{
    ...
    if (jsonDoc.is<JsonObject>())
    {
        ...
        if (strcmp(recieved_maid_code, maidcode.c_str()) == 0 &&strcmp(recieved_maid_status, "on")==0 ) // Notice：strcmp匹配完全相同才返回0
        {
          ...
          {
            analogWrite(0 /* corresonding GPIO 0 as the PWM_PIN*/,int(transformed_angle));// 设置占空比
          }
        }
        else if (strcmp(recieved_maid_code, maidcode.c_str()) == 0 && strcmp(recieved_maid_status, "off")==0)
        {
           ...
           {
            analogWrite(0 /* corresonding GPIO 0 as the PWM_PIN*/, 0);
           }
        }
    }
}
